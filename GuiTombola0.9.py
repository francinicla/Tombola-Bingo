...
class Menub(object):
    ...
    def __init__(self, window):
        ...
        """ Elemento input = oggetto Tkinter istanziato (Tk) """
        menubar = Menu(window)
...
class Board():
    ...
    def show_board(self):
        ...
        button1 = Button(tconf, text='COMINCIAMO!!', command=configu).pack(side=BOTTOM, pady=30)
...
class Cartelle():
    ...
    def __init__(self):
        ...
        elemento input = numero cartelle"""
        pass
